...
lowercase_full_names = [name for name in full_names if name.lower()]
print(lowercase_full_names)

almost_numbers = ['0', '10', '21', '3', '-7', '88', '9']
# list comprehension to create a list of integers from the above list of strings
numbers = [int(number) for number in almost_numbers if number.isdigit()]
print(numbers)
...
more_than_eleven = [name.split()[1] for name in full_names if len(name) > 11]
print(" ".join(more_than_eleven))